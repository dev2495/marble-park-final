...
const modules = [
  ...
  ['Excel Import Center','Bulk-create or update Product Master rows from Excel, including image URLs or embedded worksheet images.','/dashboard/master-data/imports',Database],
  ...
  ['Tile Master','Maintain tile size, UOM and pcs-per-box rules for tile intent rows without storing thousands of tile photos.','/dashboard/master-data/tiles',Grid3X3],
