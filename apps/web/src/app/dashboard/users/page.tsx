...
const permissionGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      ['reports.view', 'Legacy management report access'],
      ['reports.executive', 'Executive reporting'],
      ['reports.sales', 'Sales/customer/product reports'],
      ['reports.inventory', 'Inventory/lot reports'],
      ['reports.procurement', 'Procurement/vendor reports'],
      ['reports.finance', 'Receivables/credit reports'],
      ['reports.fulfilment', 'Quote-to-delivery reports'],
      ['reports.audit', 'Audit/data-quality reports'],
